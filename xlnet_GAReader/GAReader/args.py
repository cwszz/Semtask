...
def get_args(data_dir, cache_dir, embedding_folder, model_dir, log_dir,model_config_path):
    ...
    parser.add_argument("--print_step", default = 807,
    ...
    # xlnet 参数
    parser.add_argument("--xlnet_config_path",default=model_config_path,type= str,help="the config and model path for XLNet Embedding")
    parser.add_argument("--xlnet_word_dim",default=768,type= str,help="the dim for XLNet based")
