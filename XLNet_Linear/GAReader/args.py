...
def get_args(data_dir, cache_dir, embedding_folder, model_dir, log_dir,bert_config_path):
    ...
    parser.add_argument("--seed", default=1244, type=int, help="random seed")
    ...
    parser.add_argument(
        "--overwrite_cache", default=False, type=bool,help="whether overwrite the cache file"
    )
    parser.add_argument(
    ...
    parser.add_argument("--clip", default=5, type=int, help="")
    # Bert 参数
    parser.add_argument("--bert_config_path",default=bert_config_path,type= str,help="the config and model path for Bert Embedding")
    parser.add_argument("--bert_word_dim",default=768,type= str,help="the dim for Bert based")
    parser.add_argument("--windows_num", default=3, type=int, help="sliding windows number")

    # LSTM 参数
    parser.add_argument("--hidden_size", default=128, type=int, help="the number of dimension of hidden size")  # Bert 要改成768
    parser.add_argument('--rnn_num_layers', default=1, type=int, help='number of RNN layer')
    parser.add_argument("--bidirectional", default=True, type=bool)

    # GAReader
    parser.add_argument('--ga_layers', default=3, type=int, help='the layer of GAReader')
